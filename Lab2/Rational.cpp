...
double Rational:: object_doubleconv() const{                    //mi restituisce l'oggetto Rational in un valore numerico double 
...
//MEMBER FUNCTION
Rational Rational::Add(const Rational& r){ // o la faccio int e restituisco una somma, o la faccio con un generics e restituisco un oggetto
...
int  mcm_calculator(int a, int b) {              //Funzione che mi calcola l'mc tra due numeri
     int mcm = a*b;
      for(int i = mcm; i>0 ; i--){
           if(i%a == 0 and i%b == 0) mcm = i;
          }
 return mcm;     
}
Rational semplify_function(int n, int d) {       //Funzione che semplifica le frazioni
